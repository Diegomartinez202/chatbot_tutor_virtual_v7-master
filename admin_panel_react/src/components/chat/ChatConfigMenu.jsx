...
import { Settings, LogOut, Sun, Moon, Languages, UserPlus, LogIn, Shield } from "lucide-react";
...
export default function ChatConfigMenu({ className = "" }) {
    ...
    useEffect(() => {
        ...
        try {
            ...
            // Aviso opcional al resto de la app
    ...
    const changeLang = (value) => {
        ...
        // Opcional: notificar a ChatUI/transport para adjuntar metadata.lang
        ...
        <div className={`relative ${className}`}>
            ...
            {open && (
                ...
                >
                    {/* Accesibilidad */}
                    <div className="mb-3">
                        <p className="text-xs font-semibold text-gray-500 mb-2">Accesibilidad</p>
                    ...
                    <div className="mb-3">
                        <p className="text-xs font-semibold text-gray-500 mb-2">Panel administrativo</p>
                    ...
                    {zajunaSSO && (
                        <>
                            <hr className="my-2" />
                            <div className="mb-3">
                                <p className="text-xs font-semibold text-gray-500 mb-2">Zajuna</p>
                                <div className="flex flex-col gap-2">
                                    <button
                                        type="button"
                                        onClick={goZajuna}
